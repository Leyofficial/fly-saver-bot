GREETING = '''
    ...
    Я помогу тебе найти самые дешевые авиабилеты и буду следить за изменениями цен на 
    твои избранные рейсы.\n
    Вот что я умею:
...
ABOUT_BOT = "FlySaverBot помогает искать и отслеживать дешевые авиабилеты. Разработчик: Даниил Козлов."
